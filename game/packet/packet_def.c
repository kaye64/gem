...
packet_def_t packet_table_out[] = {
	...
	{ .opcode = PKT_CL_TAB_UPDATE, .type = PACKET_LEN_FIXED, .len = 3},
	...
	{ .opcode = PKT_CL_PLAYER_MESSAGE, .type = PACKET_LEN_8, .len = 0},
...
packet_def_t packet_table_in[] = {
	...
	{ .opcode = PKT_SV_WALK_ENTITY, .type = PACKET_LEN_8, .len = 0},
	...
	{ .opcode = PKT_SV_WALK_GAME, .type = PACKET_LEN_8, .len = 0},
	...
	{ .opcode = PKT_SV_WALK_MAP, .type = PACKET_LEN_8, .len = 0},
